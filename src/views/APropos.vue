...
const audiences = [
  { iconPath: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>', label: 'Particulier', text: 'Vous êtes en quête d\'un service complet qui facilite votre quotidien en prenant soin de votre logement ?' },
  { iconPath: '<rect x="4" y="2" width="16" height="20" rx="1"/><line x1="9" y1="22" x2="9" y2="12"/><line x1="15" y1="22" x2="15" y2="12"/><rect x="8" y="7" width="2" height="2"/><rect x="14" y="7" width="2" height="2"/>', label: 'Gérant d\'entreprise', text: 'Vous souhaitez améliorer l\'entretien de vos locaux professionnels afin que vos salariés travaillent dans un cadre optimal ?' },
  { iconPath: '<path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/>', label: 'Propriétaire', text: 'Vous voulez mettre votre bien en location et avez besoin d\'un professionnel de confiance pour sa remise en état ?' },
  { iconPath: '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>', label: 'Syndic de copropriété', text: 'Vous cherchez une équipe de professionnels à taille humaine, qui se chargera du nettoyage des parties communes de votre immeuble ?' },
]
  ...
  <div class="site">
    ...
    <section class="section">
      ...
      <div class="text-block">
        ...
        <p>Vous avez un bien à louer mais vous manquez de temps ? La Conciergerie Desruelle <strong>prend soin de votre patrimoine immobilier</strong>. Nous assurons le ménage avant la mise en location, publions les annonces, accompagnons pour l'état des lieux et percevons les loyers en cas d'impayés.</p>
      </div>
    ...
    <section class="section">
      <div class="two-col reverse">
        ...
        <div class="col-content">
          ...
          <p>Notre conciergerie est située à <strong>Lille (59160)</strong>, dans le Nord. Nos clients peuvent nous solliciter depuis l'intégralité de la <strong>métropole lilloise</strong> ainsi que de nombreuses <strong>communes alentours</strong> : Loos, Ronchin, La Madeleine et plus encore.</p>
          <p class="mt-12">Faites-nous confiance pour le nettoyage courant, des petits travaux de rénovation, l'accompagnement de voyageurs à Lille et bien d'autres prestations.</p>
          <div class="zone-tags">
...
.stats-bar { display: flex; justify-content: center; background: #fff; border-bottom: 1px solid #eddde4; flex-wrap: wrap; }
...
.cta-inline-actions { display: flex; gap: 12px; justify-content: center; }
...
@media (max-width: 768px) {
  ...
  .stat-item { flex: 1 1 45%; border-right: none; border-bottom: 1px solid #eddde4; padding: 16px 24px; }
}
</style>